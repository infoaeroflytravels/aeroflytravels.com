...
function AeroFeePopover() {
  ...
  return (
    <Popover className="relative inline-block">
      ...
      >
        <Popover.Button className="flex items-center gap-1 text-black font-semibold underline focus:outline-none">
          Aero Fee
        ...
        >
          <Popover.Panel
            static
            className="absolute left-0 z-50 mt-2 w-64 origin-top-left rounded-2xl border bg-white p-4 shadow-2xl"
          >
            <div className="flex flex-col items-start text-left">
              ...
              {/* Text Section */}
              <p className="px-1 font-semibold text-left w-full">Aero Fee</p>
              <p className="mt-2 px-1 text-sm text-gray-700 text-left w-full">
                <span>Aero platform and service fee.</span>{" "}
                <span>
                  You pay this only when we fulfil our on-time guarantee.
                </span>
              </p>
            </div>
          </Popover.Panel>
