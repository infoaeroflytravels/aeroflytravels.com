...
function GovernmentFeePopover() {
  ...
  return (
    <Popover className="relative">
      ...
      >
        <Popover.Button
          className="flex items-center gap-1 text-black-900 font-semibold underline focus:outline-none"
        >
          Government Fee
        ...
        >
          <Popover.Panel
            static
            className="absolute left-0 z-20 mt-2 w-64 rounded-2xl border bg-white p-4 shadow-2xl text-left"
          >
            <div className="flex flex-col items-start">
              <div className="mb-3 flex items-center justify-start rounded-full bg-blue-50 p-2">
                <svg
                  fill="none"
                  height="25"
                  viewBox="0 0 24 24"
              ...
              <p className="px-1 font-semibold text-left">Government Fee</p>
              <p className="mt-2 px-1 text-sm text-gray-700 text-left">
