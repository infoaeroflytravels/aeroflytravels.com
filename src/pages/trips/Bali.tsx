...
const BaliTourData: TourPackageProps = {
...
const BaliTourPage = () => {
  return (
    <div>
      ...
      <TourPackage
        title={BaliTourData.title}
        description={BaliTourData.description}
        pricing={BaliTourData.pricing}
        itinerary={BaliTourData.itinerary}
      />
    </div>
  );
};

export default BaliTourPage;
