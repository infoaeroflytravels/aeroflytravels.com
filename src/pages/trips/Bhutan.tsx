...
const BhutanTourData: TourPackageProps = {
...
const BhutanTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={BhutanTourData.title}
        description={BhutanTourData.description}
        pricing={BhutanTourData.pricing}
        itinerary={BhutanTourData.itinerary}
      />
    </div>
  );
};

export default BhutanTourPage;
