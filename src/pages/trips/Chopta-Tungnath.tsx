...
const ChoptaTourData: TourPackageProps = {
...
const ChoptaTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={ChoptaTourData.title}
        description={ChoptaTourData.description}
        pricing={ChoptaTourData.pricing}
        itinerary={ChoptaTourData.itinerary}
      />
    </div>
  );
};

export default ChoptaTourPage;
