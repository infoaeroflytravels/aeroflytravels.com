...
const DubaiTourData: TourPackageProps = {
...
const DubaiTourPage = () => {
  return (
    <div>
      ...
      <TourPackage
        title={DubaiTourData.title}
        description={DubaiTourData.description}
        pricing={DubaiTourData.pricing}
        itinerary={DubaiTourData.itinerary}
      />
    </div>
  );
};
