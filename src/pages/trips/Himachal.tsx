...
const HimachalTourData: TourPackageProps = {
...
const HimachalTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={HimachalTourData.title}
        description={HimachalTourData.description}
        pricing={HimachalTourData.pricing}
        itinerary={HimachalTourData.itinerary}
      />
    </div>
  );
};

export default HimachalTourPage;
