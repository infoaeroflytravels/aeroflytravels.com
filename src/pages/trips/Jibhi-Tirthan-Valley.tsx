...
const JibhiValleyTourData: TourPackageProps = {
...
const JibhiValleyTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={JibhiValleyTourData.title}
        description={JibhiValleyTourData.description}
        pricing={JibhiValleyTourData.pricing}
        itinerary={JibhiValleyTourData.itinerary}
      />
    </div>
  );
};

export default JibhiValleyTourPage;
