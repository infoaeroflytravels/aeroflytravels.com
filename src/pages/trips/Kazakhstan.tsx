...
const KazakhstanTourData: TourPackageProps = {
...
const KazakhstanTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={KazakhstanTourData.title}
        description={KazakhstanTourData.description}
        pricing={KazakhstanTourData.pricing}
        itinerary={KazakhstanTourData.itinerary}
      />
    </div>
  );
};

export default KazakhstanTourPage;
