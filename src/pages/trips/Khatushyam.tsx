...
const KhatuShyamTourData: TourPackageProps = {
...
const  KhatuShyamTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={KhatuShyamTourData.title}
        description={KhatuShyamTourData.description}
        pricing={KhatuShyamTourData.pricing}
        itinerary={KhatuShyamTourData.itinerary}
      />
    </div>
  );
};

export default KhatuShyamTourPage;
