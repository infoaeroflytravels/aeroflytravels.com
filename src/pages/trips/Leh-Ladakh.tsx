...
const LehTourPageData: TourPackageProps = {
...
const LehTourPagePage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={LehTourPageData.title}
        description={LehTourPageData.description}
        pricing={LehTourPageData.pricing}
        itinerary={LehTourPageData.itinerary}
      />
    </div>
  );
};

export default LehTourPagePage;
