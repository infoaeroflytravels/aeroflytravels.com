...
const ManaliTourData: TourPackageProps = {
...
const ManaliTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={ManaliTourData.title}
        description={ManaliTourData.description}
        pricing={ManaliTourData.pricing}
        itinerary={ManaliTourData.itinerary}
      />
    </div>
  );
};

export default ManaliTourPage;
