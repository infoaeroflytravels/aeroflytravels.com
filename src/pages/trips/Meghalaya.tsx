...
const MeghalayaTourPageData: TourPackageProps = {
...
const MeghalayaTourPagePage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={MeghalayaTourPageData.title}
        description={MeghalayaTourPageData.description}
        pricing={MeghalayaTourPageData.pricing}
        itinerary={MeghalayaTourPageData.itinerary}
      />
    </div>
  );
};

export default MeghalayaTourPagePage;
