...
const NepalTourData: TourPackageProps = {
...
const NepalTourPage = () => {
  return (
    <div>
      ...
      <TourPackage
        title={NepalTourData.title}
        description={NepalTourData.description}
        pricing={NepalTourData.pricing}
        itinerary={NepalTourData.itinerary}
      />
    </div>
  );
};

export default NepalTourPage;
