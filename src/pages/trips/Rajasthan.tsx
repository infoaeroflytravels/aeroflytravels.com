...
const RajasthanTourData: TourPackageProps = {
...
const RajasthanTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={RajasthanTourData.title}
        description={RajasthanTourData.description}
        pricing={RajasthanTourData.pricing}
        itinerary={RajasthanTourData.itinerary}
      />
    </div>
  );
};

export default RajasthanTourPage;
