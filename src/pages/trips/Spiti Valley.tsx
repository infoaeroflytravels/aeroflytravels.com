...
const SpitiTourData: TourPackageProps = {
...
const SpitiTourPage = () => {
  return (
    <div>
      ...
      <TourPackage
        title={SpitiTourData.title}
        description={SpitiTourData.description}
        pricing={SpitiTourData.pricing}
        itinerary={SpitiTourData.itinerary}
      />
    </div>
  );
};

export default SpitiTourPage;
