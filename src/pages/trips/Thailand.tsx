...
const ThailandTourData: TourPackageProps = {
...
const ThailandTourPage = () => {
  return (
    <div>
      ...
      <TourPackage
        title={ThailandTourData.title}
        description={ThailandTourData.description}
        pricing={ThailandTourData.pricing}
        itinerary={ThailandTourData.itinerary}
      />
    </div>
  );
};
