...
const UttarakhandTourData: TourPackageProps = {
...
const UttarakhandTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={UttarakhandTourData.title}
        description={UttarakhandTourData.description}
        pricing={UttarakhandTourData.pricing}
        itinerary={UttarakhandTourData.itinerary}
      />
    </div>
  );
};

export default UttarakhandTourPage;
