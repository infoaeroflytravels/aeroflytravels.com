...
const VeitnamTourData: TourPackageProps = {
...
const VeitnamTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={VeitnamTourData.title}
        description={VeitnamTourData.description}
        pricing={VeitnamTourData.pricing}
        itinerary={VeitnamTourData.itinerary}
      />
    </div>
  );
};

export default VeitnamTourPage;
