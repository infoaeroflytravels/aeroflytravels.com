...
const KashmirTourData: TourPackageProps = {
...
const KashmirTourPage = () => {
  return (
    <div>
      {/* Render the Tour Package with the data */}
      <TourPackage
        title={KashmirTourData.title}
        description={KashmirTourData.description}
        pricing={KashmirTourData.pricing}
        itinerary={KashmirTourData.itinerary}
      />
    </div>
  );
};

export default KashmirTourPage;
