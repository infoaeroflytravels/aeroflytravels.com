...
const TG = "https://media.atlys.com/b2c/clp/country-landing-page-videos/OM.mp4?tr=f-webm";
...
const govt = "https://images.prismic.io/atlys/8578f8b2-0390-4d67-9296-457dff959a6e_Oman+ministry+of+tourism.png?auto=compress,format"
const mtii = "https://images.prismic.io/atlys/0efcdc3c-958f-4cd9-b500-1f9b4d48c289_Oman+airline..png?auto=compress,format";
const tthai = "https://images.prismic.io/atlys/79035ea0-38e8-4e29-85e1-dba77e6447ab_image+%285%29.png?auto=compress,format";
...
const xyz = "https://images.prismic.io/atlys/0d38ce80-0a52-460e-aa34-f9c72fa7a762_Oman+ministry+of+foreign+affairs..png?auto=compress,format";





const alt = "https://media.atlys.com/b2c/clp/country-landing-page/tr:w-1024,h-683,q-60,f-avif/OM/fall/default";
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="hidden flex-wrap items-center space-x-4 md:flex">
              <div className="flex items-center gap-2 rounded-full py-2 pl-3 pr-5 text-[13px] font-semibold  md:w-fit md:pl-3 md:text-sm bg-primary text-white">
                ...
                </svg>Aerofly is authorized by the Government of Oman</div></div>
            ...
            <div className="bg-white   p-6  gap-2 rounded-2xl  shadow-xl border">
              <div>
                <h2 className="text-lg font-semibold lg:text-3xl">
                  <span> Oman Visa Information</span>
                </h2>
                  ...
                  <div className="group relative cursor-pointer">
                    ...
                    <div className="absolute left-0 top-full mt-2 hidden w-60 rounded-xl border bg-white p-4 text-sm text-gray-700 shadow-xl group-hover:flex flex-col group-hover:block z-10">
                      <span className="pb-2 font-medium">
                        Length of Stay: <strong>10 days</strong>
                      </span>
                      <span>
              ...
              <div className="space-y-6" id="required-documents">
                ...
                <div>
                  <h2 className="text-lg font-semibold lg:text-2xl">
                    <span>Oman Visa Requirements</span>
                  </h2>
            ...
            <div className="bg-white   p-6 rounded-2xl  shadow-xl border">
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(150px,1fr))] gap-6 justify-items-center">
                {[iata, govt, mtii, mti, tthai, xyz].map((logo, index) => (
                  <div
                    key={index}
                  ...
                  <div className="grid grid-cols-12 gap-1 ">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent">
                        <h3 className="absolute bottom-4 left-4 text-sm font-semibold text-white sm:text-xl lg:text-2xl">Oman</h3>
                      </div>
                    </div>
