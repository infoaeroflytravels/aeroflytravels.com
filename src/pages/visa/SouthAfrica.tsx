...
import southafrica from "@/assets/visa/video/TH.webm";
...
const southafricaVisaPage: React.FC = () => {
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="pt-24">
        ...
        <section className="relative max-w-7xl mx-auto rounded-2xl overflow-hidden shadow-lg">
          ...
          >
            <source src={southafrica} type="video/webm" />
            <img src={thaiimg} alt="southafrica" className="w-full h-[750px] object-cover" />
          </video>

          {/* Overlay */}
          <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center text-center p-6">
            <h1 className="text-5xl font-bold text-white mb-4">
              southafrica Digital Arrival Card (TDAC)
            </h1>
        ...
        <section className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 mt-4 px-2">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-xl font-bold underline mb-4">southafrica Visa Information</h2>
            ...
            {/* Visa Requirements */}
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="text-lg font-bold underline mb-4">southafrica Visa Requirements</h3>
      ...
      {/* Visa Process */}
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-lg font-bold underline mb-4">How southafrica Visa Process Works</h3>
...
export default southafricaVisaPage;
